...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (userRepository.count() == 0) {
            ...
            sub1.setNomeArquivo("certificado_teste_1.pdf");
            sub1.setTipoArquivo("application/pdf");
            // URL pública gerada pelo seu Supabase:
            sub1.setUrlArquivo("https://tnwpdrjyetxvtsmlfihl.supabase.co/storage/v1/object/public/certificados/certificado_teste_1.pdf");
            ...
            sub2.setNomeArquivo("certificado_teste_2.pdf");
            sub2.setTipoArquivo("application/pdf");
            // URL pública gerada pelo seu Supabase:
            sub2.setUrlArquivo("https://tnwpdrjyetxvtsmlfihl.supabase.co/storage/v1/object/public/certificados/certificado_teste_2.pdf");
